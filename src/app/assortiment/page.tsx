...
function BrandCard({ brand, index }: { brand: string; index: number }) {
  return (
    <motion.div
      ...
      whileHover={{ y: -5 }}
      className="group relative flex w-full max-w-[290px] mx-auto flex-col overflow-hidden border border-[#111]/10 bg-white transition-all duration-500 hover:border-[#111] hover:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.06)]"
    >
